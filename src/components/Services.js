            ...
            <Stack sx={{overflow: 'hidden'}} direction={{xs: 'column', md: 'row'}} spacing={4} justifyContent='center' mt={'80px'} mb='30px'>
              {
                myServices.map((service, key)=>                
                    <Paper data-aos='slide-up' data-aos-delay={`${key * 100}`} sx={{ borderRadius: '10px',height: '350px', width: '350px', display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor:'#232931', justifyContent:'center'}}>
